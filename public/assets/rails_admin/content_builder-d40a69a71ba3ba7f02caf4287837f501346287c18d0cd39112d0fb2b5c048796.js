...
$(document).on('click', '.cb-tools__btn--youtube', function() {
  var resp = prompt('Paste YouTube url', '');
...
$(document).on('click', '.cb-snippet__btn', function(e) {
  ...
  switch (snippet) {
    ...
    element += '<img src="/assets/cb-image-default-963a941501edb1b5b8b80781f23ee442bbc6e9abcb3444045cfe2a6c49a2c449.jpg" alt="Cb image default" />';
    ...
    element += '<input class="cb-search" type="text" name="search" placeholder="Search Content">';
