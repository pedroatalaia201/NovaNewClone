...
$(document).on('click', '.fc-tools__btn--slide-remove', function(e) {
  var resp = confirm('Do you want to remove this content?');
...
$(document).on('click', '.fc-snippet__btn', function(e) {
  ...
  switch (snippet) {
    ...
    element += '<img class="fc-slide__image" src="/assets/cb-image-default-963a941501edb1b5b8b80781f23ee442bbc6e9abcb3444045cfe2a6c49a2c449.jpg">';
    ...
    element += '<img class="fc-image" src="/assets/cb-image-default-963a941501edb1b5b8b80781f23ee442bbc6e9abcb3444045cfe2a6c49a2c449.jpg">';
    element += '<input class="fc-tools__input fc-tools__input--upload" type="file" name="image" id="'+ section_id +'">';
    element += '<div class="fc-tools fc-tools--center">';
    element += '<a class="fc-tools__btn fc-tools__btn--upload fa fa-camera" href="#'+ section_id + '"></a>';
    element += '</div>';
